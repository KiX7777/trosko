...
`setup.ts` is loaded by Jest before tests run. It provides the browser-like test environment and shared Testing Library setup used by component and utility tests.
