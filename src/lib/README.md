...
- `repository.ts` is the persistence abstraction. It maps Supabase rows to domain objects and provides a `localStorage` demo implementation.
...
- `ocr-api.ts` calls the browser-to-server OCR boundary.
